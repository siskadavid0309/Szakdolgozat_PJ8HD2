...
{
    public class SqlConnectorTI
    {
        private SQLiteConnection connection;

        public SqlConnectorTI(string databasePath)
        {
        ...
        public List<MovieTI> CollectMovie()
        {
            List<MovieTI> movies = new List<MovieTI>();
